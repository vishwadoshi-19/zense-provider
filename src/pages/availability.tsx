...
const AvailabilityPage = () => {
  ...
  const calculateAvailability = (staffArray: Staff[]) => {
    ...
    const availableCount = staffArray.filter(staff => staff.availability).length;
    ...
    <Layout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">Monitor and manage staff availability</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <CardContent>
              <div className="flex items-center justify-between mb-4">
                <div className="text-sm text-gray-500">
                  {attendants.filter(a => a.availability).length} of {attendants.length} available
                </div>
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium">{attendantAvailability}%</span>
                </div>
              </div>
              <div className="space-y-3">
                {attendants.map(staff => (
                  <div key={staff.id} className="flex items-center justify-between p-2 bg-gray-50 rounded-md">
                    <div>
                      <div className="font-medium">{staff.name}</div>
                      <div className="text-xs text-gray-500">{staff.contactNumber}</div>
                    </div>
                    <Button 
                      variant="ghost" 
                      size="sm" 
                      onClick={() => toggleAvailability(staff.id)}
                      className={staff.availability ? 'text-green-600' : 'text-red-600'}
                    >
                      {staff.availability ? (
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between mb-4">
                <div className="text-sm text-gray-500">
                  {nurses.filter(n => n.availability).length} of {nurses.length} available
                </div>
                <div className="flex items-center">
                  <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden mr-2">
                    <div 
                  ...
                  <span className="text-sm font-medium">{nurseAvailability}%</span>
                </div>
              </div>
              <div className="space-y-3">
                {nurses.map(staff => (
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between mb-4">
                <div className="text-sm text-gray-500">
                  {semiNurses.filter(s => s.availability).length} of {semiNurses.length} available
                </div>
                <div className="flex items-center">
                  <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden mr-2">
                    <div 
                  ...
                  <span className="text-sm font-medium">{semiNurseAvailability}%</span>
                </div>
              </div>
              <div className="space-y-3">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-blue-50 rounded-md border border-blue-100">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-medium">Jane Smith (Nurse)</div>
                    <div className="text-sm text-gray-600">Will be unavailable from March 15 to March 20</div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-md border border-green-100">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-medium">Robert Johnson (Semi-Nurse)</div>
                    <div className="text-sm text-gray-600">Will be available from March 12</div>
                  </div>
                </div>
                <Button variant="outline" size="sm">Update</Button>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-md border border-yellow-100">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-medium">Michael Brown (Nurse)</div>
                    <div className="text-sm text-gray-600">Current assignment ends on March 18</div>
                  </div>
                </div>
                <Button variant="outline" size="sm">Update</Button>
              </div>
