...
const AttendancePage = () => {
  ...
  const [attendanceList, setAttendanceList] = useState<Attendance[]>(mockAttendanceData);
  ...
  const handleMarkAttendance = (staffId: string, status: 'Present' | 'Absent' | 'Late') => {
    ...
    const existingIndex = attendanceList.findIndex(a => a.staffId === staffId && 
  ...
  const handleRecordTime = (attendanceId: string, type: 'clockIn' | 'clockOut') => {
    ...
    <Layout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">Monitor staff attendance and work hours</p>
        </div>
